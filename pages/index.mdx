...
**Notifir** is a [notification widget](https://github.com/notifir/widget) built as a web component using [Lit framework](https://lit.dev) and [Notifications API](https://github.com/notifir/api) built using [Postgraphile](https://www.graphile.org/postgraphile/).
