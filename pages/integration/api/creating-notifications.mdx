...
These section describes how you can send your first notification using curl calls. Notifir provides REST API and GraphQL API to make a
request. The new notification will be shown in the notification inbox of the recipient in real-time.
...
| x-user-hmac              | containing the computed hash for the user (required in case of hmac-based authentication) |
...
{
  "errors": [
    "An error occurred while creating new notification"
  ]
}
```
